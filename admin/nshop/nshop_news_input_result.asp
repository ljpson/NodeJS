...
Conn.Open "7npoint","sa","Ekdelsl"  
	...
	Ins="insert into nshop_news(nshop_code,writer,subject,content,kind,start_day,end_day,regdate,del) values('"&_
		session("nshop_id")&"','"&request("writer")&"','"&request("subject")&"','"&request("content")&"','"&request("kind")&"','"&_
		start_day&"','"&end_day&"',getdate(),'"&request("del")&"')"
	Conn.Execute(Ins)
...
<HTML>
<HEAD>
<TITLE>[NSHOP] 관리자툴 - 공지사항/이벤트 등록</TITLE>
</HEAD>
<STYLE TYPE="text/css">
<!--
				...
				<td align=center height=200 valign=middle class="font9" colspan=2>
					...
					<table align=center>
						<tr>
							...
							<td><input type=button  value="업체목록" class=form style="CURSOR: hand" onclick="location.replace('nshop_news_list.asp');"></td>
						</tr>
					</table>
				</td>
			</tr>		
